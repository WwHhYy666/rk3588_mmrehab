...
from evaluate.run_evaluate import (  # noqa: E402
...
from prescription.common import llm_assistant  # noqa: E402
...
def test_npu_keyframes_are_preserved_in_report_payload() -> None:
            ...
            "keyframes": [
                {
                    ...
                    "rep_index": 1,
                    "image_path": "evaluate/reports/npu/keyframes/session-npu/sit_to_stand_rep1_best.jpg",
    ...
    assert keyframes[0]["image_path"].startswith("evaluate/reports/npu/keyframes/")
    ...
    attempt = {
        "runtime_meta": {
            "keyframes": [
                ...
                {"image_path": "evaluate/reports/npu/other/not-a-keyframe.jpg"},
                {"image_path": "evaluate/reports/npu/keyframes/session/payload.png"},
            ]
        }
    }
