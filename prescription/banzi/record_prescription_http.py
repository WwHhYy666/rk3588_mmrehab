...
def draw_rknn_debug_overlay(
    ...
    *,
    ...
    debug_lines = [
        ...
        f"kpt_mode={selected_result.get('keypoint_decode_mode') or '-'} conf={selected_result.get('keypoint_conf_range')}",
...
rknn_pose_stabilizer = RknnPoseStabilizer() if RknnPoseStabilizer is not None else None
