...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--pipeline", default="yolov8_pose", choices=["yolov8_pose", "rtmdet_rtmpose", "rtmpose_fixed", "yolov8_rtmpose"])
    ...
    parser.add_argument("--pose-model", help="Path to rtmpose_fp16.rknn for the RTMPose pipelines")
...
def configure_backend_env(args: argparse.Namespace) -> None:
    ...
    elif args.pipeline == "yolov8_rtmpose":
        if args.model:
