...
if ! tr '\0' ' ' < "/proc/$pid/cmdline" | grep -Eq 'prescription/banzi/npu_rehab_8085.py|prescription\.banzi\.npu_rehab_8085'; then
...
rm -f "$PID_FILE"
echo "[OK] NPU 8085 stopped. CPU 8082 and Qwen services were not modified."
